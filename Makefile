...
pkgdatadir = $(datadir)/ulordcore
pkgincludedir = $(includedir)/ulordcore
pkglibdir = $(libdir)/ulordcore
pkglibexecdir = $(libexecdir)/ulordcore
...
CONFIG_HEADER = $(top_builddir)/src/config/ulord-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/ulord-config.h.in \
...
ACLOCAL = ${SHELL} /home/asherhu/test-UlordChain/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/asherhu/test-UlordChain/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/asherhu/test-UlordChain/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/asherhu/test-UlordChain/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
BOOST_LIBS = -L/usr/lib/x86_64-linux-gnu -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lboost_chrono -lboost_serialization
...
HARDENED_CXXFLAGS =  -Wstack-protector -fstack-protector-all -std=c++11
...
MAINT = 
MAKEINFO = ${SHELL} /home/asherhu/test-UlordChain/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = ulordcore
PACKAGE_BUGREPORT = https://github.com/ulordpay/ulord/issues
PACKAGE_NAME = Ulord Core
PACKAGE_STRING = Ulord Core 1.1.5
PACKAGE_TARNAME = ulordcore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/asherhu/test-UlordChain
abs_srcdir = /home/asherhu/test-UlordChain
abs_top_builddir = /home/asherhu/test-UlordChain
abs_top_srcdir = /home/asherhu/test-UlordChain
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/asherhu/test-UlordChain/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/ulordd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/ulord-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/ulord-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Ulord-Qt.app
OSX_DMG = Ulord-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_ulord_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_ulord_coverage.info test_ulord.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Ulord-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/ulord-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/ulord-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/ulord-config.h
$(top_srcdir)/src/config/ulord-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/ulord-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Ulord-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Ulord-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "Ulord-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Ulord-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_ulord.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_ulord -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_ulord_filtered.info: test_ulord.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_ulord_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_ulord_filtered.info
...
#test_ulord_coverage.info: baseline_filtered_combined.info test_ulord_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_ulord_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_ulord_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_ulord_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_ulord.coverage/.dirstamp:  test_ulord_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_ulord.coverage/.dirstamp total.coverage/.dirstamp

# Ulord: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_ulord.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
