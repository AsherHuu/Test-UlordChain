 ...
 * database.
 *
 * CBlock(hash=0000079b37c3c2, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=69de44, nTime=1526947274, nBits=1e09b173, nNonce=0000e865ca57d789ba, vtx=1)
 *   CTransaction(hash=69de44, ver=1, vin.size=1, vout.size=1, nLockTime=0)
 *     CTxIn(COutPoint(000000, -1), coinbase 0x)
 *     CTxOut(nValue=1.00000000, scriptPubKey=0x)
 *   vMerkleTree: 69de44
 */
...
public:
	...
	uCenter = "ucenter.uosio.org";                           // for masternode verify
	    ...
	    (   1, uint256S("0x00000743bb9a7fff0c095f4b65994d42216840a85be549b3194d6f831222b097"))
	    (   10, uint256S("0x000000ebe73cce8ace3912adeb413cae5cbf9aea653e305d857d9c14add77270"))
	    (   100, uint256S("0x0000098b98a26ebc9ff5d1a5b0266844f47cebe7ccd0d926ce961212ef787760")),
