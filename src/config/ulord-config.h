...
#define PACKAGE_BUGREPORT "https://github.com/ulordpay/ulord/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ulord Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ulord Core 1.1.5"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ulordcore"
