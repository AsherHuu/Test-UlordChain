...
5	 `major_node_nickname` VARCHAR (64) DEFAULT NULL COMMENT '主节点昵�?,
...
10	 `status` INT (3) DEFAULT '0' COMMENT '状�?0:绑定�?1:绑定确认成功,2.绑定确认失败',
11	 `validflag` INT (3) DEFAULT '0' COMMENT '有效标志�?0为无效标志，1为有效，不由用户填写' 
...
15   'balance' DECIMAL (20, 5) DEFAULT "0.00000" COMMENT '主节点锁定币的数�?,
16	 `remark` VARCHAR (255) DEFAULT NULL COMMENT '绑定确认失败原因',
17	 `audit_num` INT (3) NOT NULL DEFAULT '0' COMMENT '绑定确认次数',
18	 `auditor` VARCHAR (32) DEFAULT NULL COMMENT '绑定确认审核�?,
